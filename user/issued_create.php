...
?>
    ...
    <div 
        id="success-alert" 
        class="bg-green-100 border border-green-500 text-green-700 p-4 mb-4 rounded shadow-md"
        role="alert"
    >
        <?= $success_message; ?>
    </div>
...
<?php if (isset($error_message)): ?>
    <div 
        id="error-alert" 
        class="bg-red-100 border border-red-500 text-red-700 p-4 mb-4 rounded shadow-md"
        role="alert"
    >
        <?= $error_message; ?>
    </div>
...
<script>
    // Function to make the alert disappear after 5 seconds
    setTimeout(() => {
