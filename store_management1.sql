...
(8, 'Contractor-1', 'Chamila'),
(9, 'Contractor-2', 'Ranjeewa'),
(10, 'Contractor-3', 'Wanigasekara'),
(11, 'Contractor-4', 'Paint-Ruwan'),
(12, 'Contractor-5', 'Paint-Tikiri'),
(13, 'Contractor-6', 'Sand Blast-Amare');
...
INSERT INTO `items` (`item_id`, `item_code`, `item_name`, `specifications`, `image_url`, `category_id`, `location_id`, `quantity`, `origin_country`, `warranty_until`, `purchase_date`, `purchase_price`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
(1, 'ITEM000001', 'Power Drill', 'DeWalt 20V Max Cordless', '#', 1, 6, 10, 'USA', '2025-12-31', '2024-01-01', '299.99', 'available', 5, 2, '2024-11-12 05:50:33', '2024-11-27 06:21:17'),
(2, 'ITEM000002', 'Safety Helmet', 'Type 1 Class E', NULL, 2, 4, 18, 'Germany', '2026-12-31', '2024-01-01', '49.99', 'available', 3, 4, '2024-11-12 05:50:33', '2024-11-27 06:22:37'),
(3, 'ITEM000003', 'Measuring Tape', '25ft Stanley', '#', 1, 1, 15, 'China', '2025-06-30', '2024-01-01', '19.99', 'available', 3, 5, '2024-11-12 05:50:33', '2024-11-27 06:24:02');
...
(1, 1, 1, '2024-11-12 07:42:16', 'issue', 1, 'completed', 'Issued for maintenance work', 1),
(2, 2, 2, '2024-11-12 07:42:16', 'issue', 2, 'completed', 'Issued for team use', 1),
...
--
DELIMITER $$
CREATE TRIGGER `after_transaction_insert` AFTER INSERT ON `item_transactions` FOR EACH ROW BEGIN
...
(1, 'admin', '$2y$10$a37//9hVBO8fin3f5QQAUuqG1H2UKy1WaDD40SFj2mthnE4WMI0se', 'admin@store.com', 'System Administrator', 'admin', 'active', '2024-11-12 05:56:13', NULL),
(2, 'user', '$2y$10$z30fsDDeow1f56pBxL9A.Oh1QrEzA.ZMg3zzJk/RVwOkxlrQrBQvm', 'user@store.com', 'Regular User', 'user', 'active', '2024-11-12 05:56:13', NULL),
...
--
ALTER TABLE `employees`
  MODIFY `employee_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=182;
...
--
ALTER TABLE `sub_locations`
  MODIFY `sublocation_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
